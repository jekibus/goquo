...
geth --datadir data \
    ...
    --syncmode full --nousb \
    --raft --raftport 53002 --raftblocktime 300 --raftjoinexisting 3 --emitcheckpoints \
    --http --http.addr 172.31.16.26 --http.port 22002 --http.corsdomain "*" --http.vhosts "*" --allow-insecure-unlock \
